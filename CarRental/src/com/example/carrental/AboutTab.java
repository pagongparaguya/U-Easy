...
import com.example.Adapter.AboutPagerAdapter;
...
public class AboutTab extends FragmentActivity implements ActionBar.TabListener{

	private ActionBar actionBar;
	private ViewPager vp;
	private AboutPagerAdapter apa;
	private String[] tabs = { "Company Profile", "About" };
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		...
		actionBar.setTitle("");
		apa = new AboutPagerAdapter(getSupportFragmentManager());
	...
	public boolean onPrepareOptionsMenu (Menu menu) {
		MenuItem item = menu.findItem(R.id.action_about_us);
