...
public class ActiveRentalAdapter extends BaseAdapter{
	private static ArrayList<myRentalItem> rentallist;
	private LayoutInflater inflater;
	
	public ActiveRentalAdapter(Context context, ArrayList<myRentalItem> rentals){
		rentallist = rentals;
	...
	public View getView(int i, View convertView, ViewGroup parent) {
		...
		ViewHolder holder;
		if(convertView == null){
			convertView = inflater.inflate(R.layout.myrentals_active, null);
